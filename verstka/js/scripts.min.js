...
$(function() {
	...
	$('.main-header_select-place select').selectmenu({
		width: 'auto',
		classes: {
			'ui-selectmenu-menu': 'ui-custom-bg'
		}
	});

	$('.human-map_map img').maphilight({
		strokeColor: 'a7d2f2',
		strokeOpacity: .5,
		fillColor: '68b2ea',
		fillOpacity: .6,
	...
	$('area').hover(function() {
		$('.human-map_map-area_descr > div').hide();
		$($(this).attr('href')).show();
	}, function() {
		$($(this).attr('href')).hide();
		var id_area = $('.human-map_map-area_descr').find('div[data-show="true"]').show().attr('id');
		//$('area[data-show="true"]').trigger('mouseover');
	});

	$('area').on('click', function(event) {
		event.preventDefault();

		var data = $('area[data-click="true"]').mouseout().data('maphilight') || {};
		data.alwaysOn = !data.alwaysOn;
		$('area[data-click="true"]').attr('data-click', 'false').data('maphilight', data).trigger('alwaysOn.maphilight');

		var $this = $(this);
		$('.human-map_map-area_descr > div').hide().attr('data-show', 'false');
		$($this.attr('href')).show().attr('data-show', 'true');
