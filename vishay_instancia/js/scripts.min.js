...
"use sctict";$(function(){$(".tabs").tabs(),$(".phone").mask("+7 (999) 999-99-99"),$(".main-header a").on("click",function(a){a.preventDefault();var e=$(this),t=e.closest("ul");t.children("li").removeClass("main-header_tab-active"),$(".tab-active").removeClass("tab-active").addClass("tab-hidden"),e.parent().addClass("main-header_tab-active").appendTo(t),$(e.attr("href")).addClass("tab-active").removeClass("tab-hidden")})});